...
describe("Order repository test", () => {
  ...
  it("should update a order when change item", async () => {
    const customerRepository = new CustomerRepository();
    const customer = new Customer("123", "Customer 1");
    const address = new Address("Street 1", 1, "Zipcode 1", "City 1");
    customer.changeAddress(address);
  ...
  it("should update a order when add item", async () => {
    const customerRepository = new CustomerRepository();
    const customer = new Customer("123", "Customer 1");
    const address = new Address("Street 1", 1, "Zipcode 1", "City 1");
    customer.changeAddress(address);
  ...
  it("should update a order when remove item", async () => {
    const customerRepository = new CustomerRepository();
    const customer = new Customer("123", "Customer 1");
    const address = new Address("Street 1", 1, "Zipcode 1", "City 1");
    customer.changeAddress(address);
    ...
    let order = new Order("123", "123", [orderItem, newOrderItem]);
    const orderRepository = new OrderRepository();
    await orderRepository.create(order);
    ...
    order.removeItem(newOrderItem.id);
